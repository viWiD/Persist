...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Persist_Tests/Freddy.framework"
  install_framework "Pods-Persist_Tests/Nimble.framework"
  install_framework "Pods-Persist_Tests/OMGHTTPURLRQ.framework"
